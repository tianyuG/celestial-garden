...
// Changed bumpThreshold from 1.75 to 2.0 (code not pushed yet)
static const float bumpThreshold = 2.7;

// How many accelerometer readout will be averaged
// Changed runningAverageCount from 10 to 12 (can change back to 10 if needed)
static const uint8_t runningAverageCount = 12;

static const uint8_t blendCount = 127;

// Changed animationTimeout from 500 to 50 (code not pushed yet)
static const unsigned int animationTimeout = 50;
